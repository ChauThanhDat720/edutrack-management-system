...
const { createAbsence, approveAbsence, getAllAbsences, getMyAbsences, deleteAbsence, responseAbsence } = require('../controllers/absenceController');
...
router.put('/:id/Response', protect, responseAbsence)
